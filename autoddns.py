...
accessKeyId = "LTAI4GBreDMhgCoFmTJmKXo9"  # 将accessKeyId改成自己的accessKeyId
accessSecret = "dbcMZOmk2L4fIgG7hOUNTVHGEij4WW"  # 将accessSecret改成自己的accessSecret
domain = "oldstories.cn"  # 你的主域名
